...
TEST(TypeErasureShapeTestMVD, CircleDraw) {
  Circle circle(3.0);
...
TEST(TypeErasureShapeTestMVD, CopiedCircleDraw) {
  Circle circle(3.0);
  Shape shape(circle, SpecificDrawStrategy{});
...
TEST(TypeErasureShapeTestMVD, SquareDraw) {
  Square square(3.0);
...
TEST(TypeErasureShapeTestMVD, AllShapeDraw) {
